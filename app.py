...
PERM_UPGRADES = {'perm_strength_upgrade': {'name': 'Perm Strength Upgrade', 'atk_increase': 10}, 'perm_defense_upgrade': {'name': 'Perm Defense Upgrade', 'def_increase': 5}, 'perm_health_upgrade': {'name': 'Perm Health Upgrade', 'hp_increase': 10}, 'perm_mana_upgrade': {'name': 'Perm Mana Upgrade', 'magic_increase': 20}, 'perm_crit_chance_upgrade': {'name': 'Perm Crit Chance Upgrade', 'crit_chance_increase': 5}, 'perm_mana_regen_upgrade': {'name': 'Perm Mana Regen Upgrade', 'mana_regen_increase': 5}, 'perm_magic_def_upgrade': {'name': 'Perm Magic Defense Upgrade', 'magic_def_increase': 5}, 'perm_lifesteal_upgrade': {'name': 'Perm Lifesteal Upgrade', 'max_lifesteal_increase': 10}, 'perm_lifesteal_chance_upgrade': {'name': 'Perm Lifesteal Chance Upgrade', 'lifesteal_chance_increase': 5}, 'perm_exp_upgrade': {'name': 'Perm Exp Upgrade', 'exp_increase': 10}}
POTIONS = {'potion': {'name': 'Potion', 'effect': 'heal', 'amount': 30}, 'strong_potion': {'name': 'Strong Potion', 'effect': 'heal', 'amount': 80}, 'ultra_potion': {'name': 'Ultra Potion', 'effect': 'heal', 'amount': 200}, 'strength_boost': {'name': 'Strength Boost', 'effect': 'buff_atk', 'amount': 5, 'duration': 4}, 'defense_boost': {'name': 'Defense Boost', 'effect': 'buff_def', 'amount': 3, 'duration': 4}, 'regen_potion': {'name': 'Regen Potion', 'effect': 'buff_hp_regen', 'amount': 12, 'duration': 4}, 'crit_boost': {'name': 'Crit Boost', 'effect': 'buff_crit', 'amount': 50, 'duration': 4}, 'mana_regen_potion': {'name': 'Mana Regen Potion', 'effect': 'buff_mana_regen', 'amount': 15, 'duration': 4}, 'instant_mana': {'name': 'Instant Mana', 'effect': 'full_mana'}, 'mana_upgrade_potion': {'name': 'Mana Upgrade Potion', 'effect': 'heal_mana', 'amount': 50}}
MATERIALS = {'slime_gel': {'name': 'Slime Gel', 'rarity': 'common', 'desc': 'Gelatinous substance from slimes.'}, 'goblin_tooth': {'name': 'Goblin Tooth', 'rarity': 'common', 'desc': 'Sharp tooth from goblins.'}, 'wolf_pelt': {'name': 'Wolf Pelt', 'rarity': 'common', 'desc': 'Fur from wolves.'}, 'skeleton_bone': {'name': 'Skeleton Bone', 'rarity': 'common', 'desc': 'Bone from skeletons.'}, 'orc_iron': {'name': 'Orc Iron', 'rarity': 'common', 'desc': 'Iron forged by orcs.'}, 'bandit_cloth': {'name': 'Bandit Cloth', 'rarity': 'common', 'desc': 'Cloth from bandits.'}, 'troll_core': {'name': 'Troll Core', 'rarity': 'rare', 'desc': 'Core from trolls.'}, 'dark_essence': {'name': 'Dark Essence', 'rarity': 'rare', 'desc': 'Essence of darkness.'}, 'prism_fragment': {'name': 'Prism Fragment', 'rarity': 'rare', 'desc': 'Fragment of a prism.'}, 'void_fragment': {'name': 'Void Fragment', 'rarity': 'rare', 'desc': 'Fragment from the void.'}, 'infinitium_piece': {'name': 'Infinitium Piece', 'rarity': 'rare', 'desc': 'Piece of infinitium.'}, 'soul_shard': {'name': 'Soul Shard', 'rarity': 'rare', 'desc': 'Shard containing souls.'}, 'transcendent_heart': {'name': 'Transcendent Heart', 'rarity': 'rare', 'desc': 'Heart from transcendent beings.'}, 'dragon_scale': {'name': 'Dragon Scale', 'rarity': 'mythical', 'desc': 'Scale from dragons.'}, 'phoenix_feather': {'name': 'Phoenix Feather', 'rarity': 'mythical', 'desc': 'Feather from phoenixes.'}, 'frozen_heart': {'name': 'Frozen Heart', 'rarity': 'mythical', 'desc': 'Heart encased in ice.'}, 'thunder_core': {'name': 'Thunder Core', 'rarity': 'mythical', 'desc': 'Core of thunder.'}, 'holy_light': {'name': 'Holy Light', 'rarity': 'mythical', 'desc': 'Light imbued with holiness.'}, 'demon_horn': {'name': 'Demon Horn', 'rarity': 'mythical', 'desc': 'Horn from demons.'}, 'crystal_shard': {'name': 'Crystal Shard', 'rarity': 'mythical', 'desc': 'Shard of crystal.'}, 'star_dust': {'name': 'Star Dust', 'rarity': 'mythical', 'desc': 'Dust from stars.'}, 'moon_rock': {'name': 'Moon Rock', 'rarity': 'mythical', 'desc': 'Rock from the moon.'}, 'sun_stone': {'name': 'Sun Stone', 'rarity': 'mythical', 'desc': 'Stone powered by the sun.'}, 'spider_venom': {'name': 'Spider Venom', 'rarity': 'common', 'desc': 'Venom from giant spiders.'}, 'stone_core': {'name': 'Stone Core', 'rarity': 'common', 'desc': 'Core from stone golems.'}, 'ice_shard': {'name': 'Ice Shard', 'rarity': 'common', 'desc': 'Shard of ice.'}, 'fire_essence': {'name': 'Fire Essence', 'rarity': 'rare', 'desc': 'Essence of fire.'}, 'lightning_feather': {'name': 'Lightning Feather', 'rarity': 'rare', 'desc': 'Feather charged with lightning.'}, 'shadow_cloak': {'name': 'Shadow Cloak', 'rarity': 'rare', 'desc': 'Cloak woven from shadows.'}, 'arcane_tome': {'name': 'Arcane Tome', 'rarity': 'rare', 'desc': 'Tome of arcane knowledge.'}, 'curse_scroll': {'name': 'Curse Scroll', 'rarity': 'rare', 'desc': 'Scroll with curses.'}, 'ember': {'name': 'Ember', 'rarity': 'rare', 'desc': 'Glowing ember.'}, 'bat_wing': {'name': 'Bat Wing', 'rarity': 'common', 'desc': 'Wing from dark bats.'}}
WEAPONS = {'wooden_sword': {'name': 'Wooden Sword', 'atk': 2, 'price': 50, 'score_price': 0}, 'iron_sword': {'name': 'Iron Sword', 'atk': 5, 'price': 150, 'score_price': 0}, 'steel_sword': {'name': 'Steel Sword', 'atk': 8, 'price': 300, 'score_price': 0}, 'diamond_sword': {'name': 'Diamond Sword', 'atk': 50, 'price': 2000, 'score_price': 0}, 'void_sword': {'name': 'Void Sword', 'atk': 200, 'price': 8000, 'score_price': 0}, 'infinitium_sword': {'name': 'Infinitium Sword', 'atk': 2000, 'price': 800000, 'score_price': 25000}, 'frostblade': {'name': 'Frostblade', 'atk': 120, 'price': 5000, 'score_price': 200}, 'flameblade': {'name': 'Flameblade', 'atk': 130, 'price': 5500, 'score_price': 250}, 'thunder_sword': {'name': 'Thunder Sword', 'atk': 150, 'price': 7000, 'score_price': 400}, 'holy_avenger': {'name': 'Holy Avenger', 'atk': 180, 'price': 7500, 'score_price': 800}, 'dragon_slayer': {'name': 'Dragon Slayer', 'atk': 250, 'price': 15000, 'score_price': 1500}, 'cosmic_blade': {'name': 'Cosmic Blade', 'atk': 500, 'price': 30000, 'score_price': 3000}, 'transcendent_edge': {'name': 'Transcendent Edge', 'atk': 1500, 'price': 500000, 'score_price': 10000}}
ARMORS = {'leather_armor': {'name': 'Leather Armor', 'def': 1, 'price': 50}, 'chainmail': {'name': 'Chainmail', 'def': 3, 'price': 150}, 'plate_armor': {'name': 'Plate Armor', 'def': 6, 'price': 300}, 'diamond_armor': {'name': 'Diamond Armor', 'def': 25, 'price': 2000}, 'void_armor': {'name': 'Void Armor', 'def': 75, 'price': 8000}, 'infinitium_armor': {'name': 'Infinitium Armor', 'def': 300, 'price': 800000, 'score_price': 2500}, 'frost_armor': {'name': 'Frost Armor', 'def': 40, 'price': 4000, 'score_price': 150}, 'flame_armor': {'name': 'Flame Armor', 'def': 45, 'price': 4500, 'score_price': 200}, 'thunder_armor': {'name': 'Thunder Armor', 'def': 55, 'price': 6000, 'score_price': 350}, 'holy_armor': {'name': 'Holy Armor', 'def': 70, 'price': 9000, 'score_price': 700}, 'dragon_scale_armor': {'name': 'Dragon Scale Armor', 'def': 100, 'price': 14000, 'score_price': 1400}, 'cosmic_armor': {'name': 'Cosmic Armor', 'def': 200, 'price': 280000, 'score_price': 2800}, 'transcendent_armor': {'name': 'Transcendent Armor', 'def': 500, 'price': 950000, 'score_price': 9500}}
WANDS = {'apprentice_wand': {'name': 'Apprentice Wand', 'magic_atk': 5, 'price': 120}, 'mage_wand': {'name': 'Mage Wand', 'magic_atk': 20, 'price': 800}, 'archmage_staff': {'name': 'Archmage Staff', 'magic_atk': 120, 'price': 12000, 'score_price': 200}, 'frost_wand': {'name': 'Frost Wand', 'magic_atk': 60, 'price': 4000, 'score_price': 150}, 'flame_wand': {'name': 'Flame Wand', 'magic_atk': 65, 'price': 4500, 'score_price': 200}, 'thunder_wand': {'name': 'Thunder Wand', 'magic_atk': 75, 'price': 6000, 'score_price': 350}, 'holy_scepter': {'name': 'Holy Scepter', 'magic_atk': 90, 'price': 9000, 'score_price': 700}, 'dragon_staff': {'name': 'Dragon Staff', 'magic_atk': 125, 'price': 14000, 'score_price': 1400}, 'cosmic_scepter': {'name': 'Cosmic Scepter', 'magic_atk': 250, 'price': 28000, 'score_price': 2800}, 'transcendent_staff': {'name': 'Transcendent Staff', 'magic_atk': 750, 'price': 95000, 'score_price': 9500}}
ROBES = {'cloth_robe': {'name': 'Cloth Robe', 'magic_def': 2, 'price': 100}, 'silk_robe': {'name': 'Silk Robe', 'magic_def': 10, 'price': 900}, 'void_robe': {'name': 'Void Robe', 'magic_def': 80, 'price': 20000, 'score_price': 500}, 'frost_robe': {'name': 'Frost Robe', 'magic_def': 30, 'price': 4000, 'score_price': 150}, 'flame_robe': {'name': 'Flame Robe', 'magic_def': 35, 'price': 4500, 'score_price': 200}, 'thunder_robe': {'name': 'Thunder Robe', 'magic_def': 45, 'price': 6000, 'score_price': 350}, 'holy_robe': {'name': 'Holy Robe', 'magic_def': 60, 'price': 9000, 'score_price': 700}, 'dragon_robe': {'name': 'Dragon Robe', 'magic_def': 90, 'price': 14000, 'score_price': 1400}, 'cosmic_robe': {'name': 'Cosmic Robe', 'magic_def': 180, 'price': 28000, 'score_price': 2800}, 'transcendent_robe': {'name': 'Transcendent Robe', 'magic_def': 450, 'price': 95000, 'score_price': 9500}}
NECKLACES = {'health_amulet': {'name': 'Health Amulet', 'hp_bonus': 20, 'price': 500}, 'mana_amulet': {'name': 'Mana Amulet', 'mana_bonus': 15, 'price': 600}, 'strength_amulet': {'name': 'Strength Amulet', 'atk_bonus': 5, 'price': 700}, 'defense_amulet': {'name': 'Defense Amulet', 'def_bonus': 3, 'price': 650}, 'crit_amulet': {'name': 'Critical Amulet', 'crit_bonus': 10, 'price': 800}, 'lifesteal_amulet': {'name': 'Lifesteal Amulet', 'lifesteal_bonus': 5, 'price': 900}, 'frost_necklace': {'name': 'Frost Necklace', 'magic_def_bonus': 15, 'hp_bonus': 30, 'price': 3000, 'score_price': 100}, 'flame_necklace': {'name': 'Flame Necklace', 'magic_atk_bonus': 10, 'atk_bonus': 8, 'price': 3500, 'score_price': 150}, 'thunder_necklace': {'name': 'Thunder Necklace', 'crit_bonus': 15, 'atk_bonus': 10, 'price': 5000, 'score_price': 300}, 'holy_pendant': {'name': 'Holy Pendant', 'hp_bonus': 50, 'mana_bonus': 30, 'def_bonus': 5, 'price': 8000, 'score_price': 600}, 'dragon_necklace': {'name': 'Dragon Necklace', 'atk_bonus': 20, 'def_bonus': 15, 'hp_bonus': 70, 'price': 12000, 'score_price': 1200}, 'cosmic_necklace': {'name': 'Cosmic Necklace', 'magic_atk_bonus': 30, 'magic_def_bonus': 25, 'mana_bonus': 50, 'price': 24000, 'score_price': 2400}, 'transcendent_necklace': {'name': 'Transcendent Necklace', 'atk_bonus': 50, 'def_bonus': 40, 'hp_bonus': 150, 'mana_bonus': 100, 'crit_bonus': 20, 'lifesteal_bonus': 10, 'price': 800000, 'score_price': 8000}}
...
def get_item_rarity(item_key):
    ...
    if item_key in WEAPONS:
        ...
        return 'common'
TITLES = {'novice': {'name': 'Novice', 'rarity': 'common', 'atk_boost': 0, 'def_boost': 0, 'hp_boost': 0, 'mana_boost': 0, 'exp_boost': 0, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'A beginner adventurer'}, 'apprentice': {'name': 'Apprentice', 'rarity': 'common', 'atk_boost': 1, 'def_boost': 1, 'hp_boost': 5, 'mana_boost': 5, 'exp_boost': 0, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Learning the ways of combat'}, 'warrior': {'name': 'Warrior', 'rarity': 'common', 'atk_boost': 2, 'def_boost': 2, 'hp_boost': 10, 'mana_boost': 0, 'exp_boost': 0, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'A skilled fighter'}, 'champion': {'name': 'Champion', 'rarity': 'rare', 'atk_boost': 3, 'def_boost': 3, 'hp_boost': 15, 'mana_boost': 10, 'exp_boost': 5, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'A true hero'}, 'legend': {'name': 'Legend', 'rarity': 'rare', 'atk_boost': 4, 'def_boost': 4, 'hp_boost': 20, 'mana_boost': 15, 'exp_boost': 10, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Known throughout the lands'}, 'master': {'name': 'Master', 'rarity': 'rare', 'atk_boost': 5, 'def_boost': 5, 'hp_boost': 25, 'mana_boost': 20, 'exp_boost': 15, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'A master of their craft'}, 'grandmaster': {'name': 'Grandmaster', 'rarity': 'mythical', 'atk_boost': 6, 'def_boost': 6, 'hp_boost': 30, 'mana_boost': 25, 'exp_boost': 20, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'A supreme expert'}, 'slayer': {'name': 'Slayer', 'rarity': 'mythical', 'atk_boost': 7, 'def_boost': 7, 'hp_boost': 35, 'mana_boost': 30, 'exp_boost': 25, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 10, 'def_percent': 5, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Monster slayer extraordinaire'}, 'hunter': {'name': 'Hunter', 'rarity': 'mythical', 'atk_boost': 8, 'def_boost': 8, 'hp_boost': 40, 'mana_boost': 35, 'exp_boost': 30, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 20, 'def_percent': 10, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Master hunter'}, 'slayer_ii': {'name': 'Slayer II', 'rarity': 'prismatic', 'atk_boost': 9, 'def_boost': 9, 'hp_boost': 45, 'mana_boost': 40, 'exp_boost': 35, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 25, 'def_percent': 15, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Legendary monster slayer'}, 'boss_slayer': {'name': 'Boss Slayer', 'rarity': 'prismatic', 'atk_boost': 10, 'def_boost': 10, 'hp_boost': 50, 'mana_boost': 45, 'exp_boost': 40, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 30, 'def_percent': 20, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Boss defeating champion'}, 'boss_master': {'name': 'Boss Master', 'rarity': 'prismatic', 'atk_boost': 11, 'def_boost': 11, 'hp_boost': 55, 'mana_boost': 50, 'exp_boost': 45, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 35, 'def_percent': 25, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Master of bosses'}, 'millionaire': {'name': 'Millionaire', 'rarity': 'divine', 'atk_boost': 12, 'def_boost': 12, 'hp_boost': 60, 'mana_boost': 55, 'exp_boost': 50, 'material_discount_percent': 0, 'money_boost_percent': 20, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Extremely wealthy'}, 'arcane_master': {'name': 'Arcane Master', 'rarity': 'divine', 'atk_boost': 13, 'def_boost': 13, 'hp_boost': 65, 'mana_boost': 60, 'exp_boost': 55, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 10, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 20, 'desc': 'Master of magic'}, 'artisan': {'name': 'Artisan', 'rarity': 'divine', 'atk_boost': 14, 'def_boost': 14, 'hp_boost': 70, 'mana_boost': 65, 'exp_boost': 60, 'material_discount_percent': 20, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Master craftsman'}, 'collector': {'name': 'Collector', 'rarity': 'transcendent', 'atk_boost': 15, 'def_boost': 15, 'hp_boost': 75, 'mana_boost': 70, 'exp_boost': 65, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 20, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Ultimate collector'}, 'immortal': {'name': 'Immortal', 'rarity': 'transcendent', 'atk_boost': 16, 'def_boost': 16, 'hp_boost': 80, 'mana_boost': 75, 'exp_boost': 70, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': -30, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Has cheated death many times'}, 'perfect': {'name': 'Perfect', 'rarity': 'transcendent', 'atk_boost': 17, 'def_boost': 17, 'hp_boost': 85, 'mana_boost': 80, 'exp_boost': 75, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 10, 'def_percent': 10, 'hp_percent': 20, 'mana_percent': 20, 'desc': 'Achieved perfection'}, 'legendary': {'name': 'Legendary', 'rarity': 'transcendent', 'atk_boost': 18, 'def_boost': 18, 'hp_boost': 90, 'mana_boost': 85, 'exp_boost': 80, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 30, 'def_percent': 30, 'hp_percent': 20, 'mana_percent': 0, 'desc': 'A living legend'}, 'deity': {'name': 'Deity', 'rarity': 'transcendent', 'atk_boost': 19, 'def_boost': 19, 'hp_boost': 95, 'mana_boost': 90, 'exp_boost': 85, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 40, 'def_percent': 40, 'hp_percent': 30, 'mana_percent': 30, 'desc': 'God among men'}, 'treasure_king': {'name': 'Treasure King', 'rarity': 'transcendent', 'atk_boost': 20, 'def_boost': 20, 'hp_boost': 100, 'mana_boost': 95, 'exp_boost': 90, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 20, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Master of treasures'}, 'fortunes_favorite': {'name': "Fortune's Favorite", 'rarity': 'transcendent', 'atk_boost': 21, 'def_boost': 21, 'hp_boost': 105, 'mana_boost': 100, 'exp_boost': 95, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 20, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Always lucky'}, 'mytic': {'name': 'Mythic', 'rarity': 'mythical', 'atk_boost': 8, 'def_boost': 8, 'hp_boost': 40, 'mana_boost': 35, 'exp_boost': 30, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Mythical being'}, 'transcendent': {'name': 'Transcendent', 'rarity': 'transcendent', 'atk_boost': 15, 'def_boost': 15, 'hp_boost': 75, 'mana_boost': 70, 'exp_boost': 65, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'Beyond mortal limits'}, 'godlike': {'name': 'Godlike', 'rarity': 'transcendent', 'atk_boost': 22, 'def_boost': 22, 'hp_boost': 110, 'mana_boost': 105, 'exp_boost': 100, 'material_discount_percent': 0, 'money_boost_percent': 0, 'material_boost_percent': 0, 'treasure_boost_percent': 0, 'crit_chance_percent': 0, 'death_penalty_percent': 0, 'hp_regen_percent': 0, 'atk_percent': 0, 'def_percent': 0, 'hp_percent': 0, 'mana_percent': 0, 'desc': 'A god among mortals'}}
ACHIEVEMENTS = {'first_monster': {'name': 'First Blood', 'title': 'Slayer', 'condition': lambda stats: stats.get('monsters_defeated', 0) >= 1, 'desc': 'Defeat 1 monster'}, 'hundred_monsters': {'name': 'Monster Hunter', 'title': 'Hunter', 'condition': lambda stats: stats.get('monsters_defeated', 0) >= 100, 'desc': 'Defeat 100 monsters'}, 'thousand_monsters': {'name': 'Monster Slayer', 'title': 'Slayer II', 'condition': lambda stats: stats.get('monsters_defeated', 0) >= 1000, 'desc': 'Defeat 1000 monsters'}, 'boss_defeats_10': {'name': 'Boss Hunter', 'title': 'Boss Slayer', 'condition': lambda stats: stats.get('bosses_defeated', 0) >= 10, 'desc': 'Defeat 10 bosses'}, 'boss_defeats_50': {'name': 'Boss Master', 'title': 'Boss Master', 'condition': lambda stats: stats.get('bosses_defeated', 0) >= 50, 'desc': 'Defeat 50 bosses'}, 'millionaire': {'name': 'Wealthy', 'title': 'Millionaire', 'condition': lambda stats: stats.get('total_money_earned', 0) >= 1000000, 'desc': 'Earn 1,000,000 total money'}, 'spell_master': {'name': 'Spellcaster', 'title': 'Arcane Master', 'condition': lambda stats: len(stats.get('learned_spells', [])) >= 10, 'desc': 'Learn 10 spells'}, 'crafting_expert': {'name': 'Craftsman', 'title': 'Artisan', 'condition': lambda stats: stats.get('items_crafted', 0) >= 50, 'desc': 'Craft 50 items'}, 'collector': {'name': 'Collector', 'title': 'Collector', 'condition': lambda stats: stats.get('materials_collected', 0) >= 500, 'desc': 'Collect 500 materials'}, 'survivor': {'name': 'Survivor', 'title': 'Immortal', 'condition': lambda stats: stats.get('times_died', 0) >= 100, 'desc': 'Die 100 times'}, 'perfectionist': {'name': 'Perfect Game', 'title': 'Perfect', 'condition': lambda stats: stats.get('monsters_defeated', 0) >= 1000 and stats.get('bosses_defeated', 0) >= 10 and (len(stats.get('learned_spells', [])) >= 5) and (stats.get('level', 1) >= 50), 'desc': 'Defeat 1000 monsters, 10 bosses, learn 5 spells, reach level 50'}, 'legendary': {'name': 'Legendary Adventurer', 'title': 'Legendary', 'condition': lambda stats: stats.get('monsters_defeated', 0) >= 5000 and stats.get('bosses_defeated', 0) >= 100 and (stats.get('level', 1) >= 80), 'desc': 'Defeat 5000 monsters, 100 bosses, reach level 80'}, 'godlike': {'name': 'God Among Men', 'title': 'Deity', 'condition': lambda stats: stats.get('monsters_defeated', 0) >= 10000 and stats.get('bosses_defeated', 0) >= 200 and (stats.get('level', 1) >= 100), 'desc': 'Defeat 10000 monsters, 200 bosses, reach level 100'}, 'treasure_hunter': {'name': 'Treasure Hunter', 'title': 'Treasure King', 'condition': lambda stats: stats.get('dungeon_treasure_collected', 0) >= 500000, 'desc': 'Collect 500,000 from dungeon treasure'}, 'lucky': {'name': 'Lucky', 'title': "Fortune's Favorite", 'condition': lambda stats: stats.get('critical_hits', 0) >= 1000, 'desc': 'Land 1000 critical hits'}}
...
def default_player_data():
    ...
    return {'money': 40, 'score': 0, 'stats': {'hp_max': 100, 'hp': 100, 'atk': 5, 'defense': 0, 'level': 1, 'exp': 0, 'mana_max': 100, 'mana': 100, 'current_area': 1, 'equipped': {'weapon': None, 'armor': None, 'wand': None, 'robe': None, 'necklace': None}, 'settings': {'call_including_title': True, 'show_exp_bar': False, 'auto_equip_best': False, 'auto_equip_spells': False, 'auto_equip_titles': False, 'auto_equip_everything': False}, 'perm_atk': 0, 'perm_def': 0, 'perm_hp_max': 0, 'perm_mana_max': 0, 'perm_magic_def': 0, 'perm_crit_chance': 0, 'perm_mana_regen': 0, 'perm_lifesteal': 0, 'perm_lifesteal_chance': 0, 'perm_exp_boost': 0, 'title': get_title(1), 'achievements': [], 'monsters_defeated': 0, 'bosses_defeated': 0, 'total_money_earned': 0, 'items_crafted': 0, 'materials_collected': 0, 'times_died': 0, 'dungeon_treasure_collected': 0, 'critical_hits': 0, 'stats_manually_set': {'hp': False, 'hp_max': False, 'atk': False, 'defense': False, 'mana': False, 'mana_max': False}, 'dodge_points': 3, 'max_dodge': 3, 'learned_spells': [], 'equipped_spells': [None, None, None, None], 'available_titles': ['novice'], 'equipped_titles': [None, None, None, None, None], 'title_atk_boost': 0, 'title_def_boost': 0, 'title_hp_boost': 0, 'title_mana_boost': 0, 'title_exp_boost': 0}, 'inventory': inv}
...
MAGIC_PACKS = {'common_magic_pack': {'name': 'Common Magic Pack', 'tier': 'D(Common)', 'spells': ['spark', 'ember', 'aqua_jet', 'gust', 'stone_toss', 'mana_bolt'], 'drop_count': (1, 2), 'description': 'Contains 1-2 common spells'}, 'rare_magic_pack': {'name': 'Rare Magic Pack', 'tier': 'C(Rare)', 'spells': ['spark', 'ember', 'aqua_jet', 'gust', 'stone_toss', 'mana_bolt', 'fireball', 'ice_spike', 'shadow_shot', 'thunder_strike', 'poison_mist', 'spark_chain'], 'drop_count': (1, 3), 'description': 'Contains 1-3 spells (common or rare)'}, 'mythical_magic_pack': {'name': 'Mythical Magic Pack', 'tier': 'B(Mythical)', 'spells': ['fireball', 'ice_spike', 'shadow_shot', 'thunder_strike', 'poison_mist', 'spark_chain', 'meteor', 'frost_nova', 'void_bolt', 'life_drain', 'earth_quake', 'glacial_prison'], 'drop_count': (2, 4), 'description': 'Contains 2-4 spells (rare or mythical)'}, 'prismatic_magic_pack': {'name': 'Prismatic Magic Pack', 'tier': 'A(Prismatic)', 'spells': ['meteor', 'frost_nova', 'void_bolt', 'life_drain', 'earth_quake', 'glacial_prison', 'prism_beam', 'lightning_storm', 'aether_blast', 'mirror_shield', 'prismatic_orb', 'prismatic_shard'], 'drop_count': (2, 4), 'description': 'Contains 2-4 spells (mythical or prismatic)'}, 'divine_magic_pack': {'name': 'Divine Magic Pack', 'tier': 'S(Divine)', 'spells': ['prism_beam', 'lightning_storm', 'aether_blast', 'mirror_shield', 'prismatic_orb', 'prismatic_shard', 'divine_wrath', 'holy_barrier', 'celestial_fall', 'purge', 'resurgence', 'spectral_bind'], 'drop_count': (3, 5), 'description': 'Contains 3-5 spells (prismatic or divine)'}, 'transcendent_magic_pack': {'name': 'Transcendent Magic Pack', 'tier': 'SS(Transcendent)', 'spells': ['divine_wrath', 'holy_barrier', 'celestial_fall', 'purge', 'resurgence', 'spectral_bind', 'transcendence', 'unmaking', 'voidstorm', 'eternal_echo', 'reality_rend'], 'drop_count': (3, 5), 'description': 'Contains 3-5 spells (divine or transcendent)'}}
SPELLS_BY_KEY = {'spark': {'name': 'Spark', 'class': 'D(Common)', 'type': 'lightning', 'mana': 4, 'power': 8, 'lvl': 1, 'desc': 'Small electric spark.'}, 'ember': {'name': 'Ember', 'class': 'D(Common)', 'type': 'fire', 'mana': 4, 'power': 9, 'lvl': 1, 'desc': 'Tiny firebolt.'}, 'aqua_jet': {'name': 'Aqua Jet', 'class': 'D(Common)', 'type': 'ice', 'mana': 5, 'power': 10, 'lvl': 2, 'desc': 'Jet of melted ice.'}, 'gust': {'name': 'Gust', 'class': 'D(Common)', 'type': 'wind', 'mana': 4, 'power': 7, 'lvl': 1, 'desc': 'Blows at enemy.'}, 'stone_toss': {'name': 'Stone Toss', 'class': 'D(Common)', 'type': 'nature', 'mana': 6, 'power': 12, 'lvl': 2, 'desc': 'Small rock hurled.'}, 'mana_bolt': {'name': 'Mana Bolt', 'class': 'D(Common)', 'type': 'mana', 'mana': 6, 'power': 14, 'lvl': 3, 'desc': 'Basic mana projectile.'}, 'spark_chain': {'name': 'Spark Chain', 'class': 'C(Rare)', 'type': 'lightning', 'mana': 22, 'power': 80, 'lvl': 15, 'desc': 'Chaining sparks.'}, 'fireball': {'name': 'Fireball', 'class': 'C(Rare)', 'type': 'fire', 'mana': 15, 'power': 40, 'lvl': 10, 'desc': 'Explosive orb.'}, 'ice_spike': {'name': 'Ice Spike', 'class': 'C(Rare)', 'type': 'ice', 'mana': 14, 'power': 36, 'lvl': 9, 'desc': 'Sharp ice.'}, 'shadow_shot': {'name': 'Shadow Shot', 'class': 'C(Rare)', 'type': 'mana', 'mana': 16, 'power': 45, 'lvl': 11, 'desc': 'Dark bolt.'}, 'thunder_strike': {'name': 'Thunder Strike', 'class': 'C(Rare)', 'type': 'lightning', 'mana': 18, 'power': 50, 'lvl': 12, 'desc': 'Powerful lightning.'}, 'poison_mist': {'name': 'Poison Mist', 'class': 'C(Rare)', 'type': 'wind', 'mana': 12, 'power': 30, 'lvl': 10, 'desc': 'Toxic cloud.'}, 'meteor': {'name': 'Meteor', 'class': 'B(Mythical)', 'type': 'nature', 'mana': 55, 'power': 220, 'lvl': 30, 'desc': 'Crushing meteor.'}, 'frost_nova': {'name': 'Frost Nova', 'class': 'B(Mythical)', 'type': 'ice', 'mana': 45, 'power': 160, 'lvl': 28, 'desc': 'Freezes area.'}, 'void_bolt': {'name': 'Void Bolt', 'class': 'B(Mythical)', 'type': 'mana', 'mana': 60, 'power': 250, 'lvl': 32, 'desc': 'Nullifying energy.'}, 'life_drain': {'name': 'Life Drain', 'class': 'B(Mythical)', 'type': 'mana', 'mana': 50, 'power': 150, 'lvl': 30, 'desc': 'Steal HP.'}, 'earth_quake': {'name': 'nature Quake', 'class': 'B(Mythical)', 'type': 'nature', 'mana': 48, 'power': 180, 'lvl': 31, 'desc': 'Shake the ground.'}, 'glacial_prison': {'name': 'Glacial Prison', 'class': 'B(Mythical)', 'type': 'ice', 'mana': 70, 'power': 300, 'lvl': 35, 'desc': 'Encase the enemy.'}, 'prism_beam': {'name': 'Prism Beam', 'class': 'A(Prismatic)', 'type': 'mana', 'mana': 120, 'power': 700, 'lvl': 50, 'desc': 'Shredding beam.'}, 'lightning_storm': {'name': 'Lightning Storm', 'class': 'A(Prismatic)', 'type': 'lightning', 'mana': 110, 'power': 650, 'lvl': 48, 'desc': 'Storm of lightning.'}, 'aether_blast': {'name': 'Aether Blast', 'class': 'A(Prismatic)', 'type': 'mana', 'mana': 100, 'power': 600, 'lvl': 46, 'desc': 'Pure aether.'}, 'mirror_shield': {'name': 'Mirror Shield', 'class': 'A(Prismatic)', 'type': 'mana', 'mana': 40, 'power': 0, 'lvl': 45, 'desc': 'Reflect attacks.'}, 'prismatic_orb': {'name': 'Prismatic Orb', 'class': 'A(Prismatic)', 'type': 'mana', 'mana': 90, 'power': 520, 'lvl': 47, 'desc': 'Orb of prismatic energy.'}, 'prismatic_shard': {'name': 'Prismatic Shard', 'class': 'A(Prismatic)', 'type': 'mana', 'mana': 95, 'power': 560, 'lvl': 52, 'desc': 'Shards of light.'}, 'divine_wrath': {'name': 'Divine Wrath', 'class': 'S(Divine)', 'type': 'mana', 'mana': 300, 'power': 2000, 'lvl': 75, 'desc': 'Wrath of the gods.'}, 'holy_barrier': {'name': 'Holy Barrier', 'class': 'S(Divine)', 'type': 'heal', 'mana': 120, 'power': 0, 'lvl': 70, 'desc': 'Major protection.'}, 'celestial_fall': {'name': 'Celestial Fall', 'class': 'S(Divine)', 'type': 'nature', 'mana': 250, 'power': 1500, 'lvl': 72, 'desc': 'Celestial impact.'}, 'purge': {'name': 'Purge', 'class': 'S(Divine)', 'type': '', 'mana': 100, 'power': 480, 'lvl': 68, 'desc': 'Remove curses.'}, 'resurgence': {'name': 'Resurgence', 'class': 'S(Divine)', 'type': 'heal', 'mana': 200, 'power': 0, 'lvl': 74, 'desc': 'Large heal.'}, 'spectral_bind': {'name': 'Spectral Bind', 'class': 'S(Divine)', 'type': 'mana', 'mana': 180, 'power': 820, 'lvl': 66, 'desc': 'Bind spirit.'}, 'transcendence': {'name': 'Transcendence', 'class': 'SS(Transcendent)', 'type': 'mana', 'mana': 900, 'power': 8000, 'lvl': 95, 'desc': 'Transcend reality.'}, 'unmaking': {'name': 'Unmaking', 'class': 'SS(Transcendent)', 'type': 'mana', 'mana': 800, 'power': 7000, 'lvl': 90, 'desc': 'Unmake existence.'}, 'voidstorm': {'name': 'Voidstorm', 'class': 'SS(Transcendent)', 'type': 'mana', 'mana': 850, 'power': 7500, 'lvl': 92, 'desc': 'Storm of void.'}, 'eternal_echo': {'name': 'Eternal Echo', 'class': 'SS(Transcendent)', 'type': 'mana', 'mana': 950, 'power': 8500, 'lvl': 96, 'desc': 'Echo through eternity.'}, 'reality_rend': {'name': 'Reality Rend', 'class': 'SS(Transcendent)', 'type': 'mana', 'mana': 1000, 'power': 9000, 'lvl': 98, 'desc': 'Tear reality apart.'}}
MAGIC_PACK_ALIASES = {'common': 'common_magic_pack', 'c': 'common_magic_pack', 'rare': 'rare_magic_pack', 'r': 'rare_magic_pack', 'mythical': 'mythical_magic_pack', 'm': 'mythical_magic_pack', 'prismatic': 'prismatic_magic_pack', 'p': 'prismatic_magic_pack', 'divine': 'divine_magic_pack', 'd': 'divine_magic_pack', 'transcendent': 'transcendent_magic_pack', 't': 'transcendent_magic_pack'}
