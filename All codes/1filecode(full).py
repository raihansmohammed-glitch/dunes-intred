...
MAGIC_PACKS = {'common_magic_pack': {'name': 'Common Magic Pack', 'tier': 'D(Common)', 'spells': ['spark', 'ember', 'aqua_jet', 'gust', 'stone_toss', 'mana_bolt'], 'drop_count': (1, 2), 'description': 'Contains 1-2 common spells'},
...
def calculate_total_crit_chance(stats, active_buffs):
    ...
    return total
MONSTERS = [
    {'name': 'Slime', 'hp': 8, 'atk_min': 1, 'atk_max': 3, 'money_min': 2, 'money_max': 7, 'class': 'D(Common)', 'is_boss': False, 'is_super_boss': False, 'drop': {'potion': 0.25, 'slime_gel': 0.4},
    'weight': 18, 'area': 1, 'element': 'nature', 'exp_min': 10, 'exp_max': 25},
    {'name': 'Goblin', 'hp': 10, 'atk_min': 3, 'atk_max': 5, 'money_min': 4, 'money_max': 15, 'class': 'D(Common)', 'is_boss': False, 'is_super_boss': False, 'drop': {'potion': 0.3, 'strength_boost': 0.05, 'goblin_tooth': 0.3},
    'weight': 15, 'area': 1, 'element': 'mana', 'exp_min': 10, 'exp_max': 25},
    {'name': 'Wolf', 'hp': 12, 'atk_min': 3, 'atk_max': 6, 'money_min': 10, 'money_max': 22, 'class': 'D(Common)', 'is_boss': False, 'is_super_boss': False, 'drop': {'potion': 0.2, 'wolf_pelt': 0.3},
    'weight': 14, 'area': 1, 'element': 'nature', 'exp_min': 10, 'exp_max': 25},
    {'name': 'Goblin Shaman', 'hp': 20, 'magic_atk_min': 8, 'magic_atk_max': 12, 'money_min': 10, 'money_max': 25, 'class': 'C(Rare)', 'is_boss': False, 'is_super_boss': False, 'drop': {'mana_regen_potion': 0.1, 'goblin_tooth': 0.2},
    'weight': 8, 'area': 1, 'element': 'mana', 'exp_min': 10, 'exp_max': 25},
    {'name': 'Forest Sprite', 'hp': 15, 'atk_min': 2, 'atk_max': 5, 'money_min': 8, 'money_max': 20, 'class': 'D(Common)', 'is_boss': False, 'is_super_boss': False, 'drop': {'potion': 0.25, 'mana_regen_potion': 0.1, 'crystal_shard': 0.2},
    'weight': 12, 'area': 1, 'element': 'nature', 'exp_min': 10, 'exp_max': 25},
    {'name': 'Skeleton', 'hp': 20, 'atk_min': 4, 'atk_max': 7, 'money_min': 15, 'money_max': 30, 'class': 'D(Common)', 'is_boss': False, 'is_super_boss': False, 'drop': {'potion': 0.25, 'defense_boost': 0.05, 'skeleton_bone': 0.4},
    'weight': 12, 'area': 2, 'element': 'mana', 'exp_min': 15, 'exp_max': 37},
    {'name': 'Orc', 'hp': 30, 'atk_min': 5, 'atk_max': 8, 'money_min': 20, 'money_max': 40, 'class': 'D(Common)', 'is_boss': False, 'is_super_boss': False, 'drop': {'potion': 0.2, 'orc_iron': 0.3},
    'weight': 10, 'area': 2, 'element': 'mana', 'exp_min': 15, 'exp_max': 37},
    {'name': 'Giant Spider', 'hp': 25, 'atk_min': 6, 'atk_max': 9, 'money_min': 25, 'money_max': 45, 'class': 'D(Common)', 'is_boss': False, 'is_super_boss': False, 'drop': {'potion': 0.2, 'crit_boost': 0.05, 'spider_venom': 0.3},
    'weight': 8, 'area': 2, 'element': 'nature', 'exp_min': 15, 'exp_max': 37},
    {'name': 'Dark Bat', 'hp': 18, 'atk_min': 5, 'atk_max': 8, 'money_min': 18, 'money_max': 35, 'class': 'D(Common)', 'is_boss': False, 'is_super_boss': False, 'drop': {'potion': 0.2, 'bat_wing': 0.3},
    'weight': 10, 'area': 2, 'element': 'nature', 'exp_min': 15, 'exp_max': 37},
    ...
    'weight': 10, 'area': 3, 'element': 'mana', 'exp_min': 22, 'exp_max': 56},
    ...
    'weight': 8, 'area': 3, 'element': 'mana', 'exp_min': 22, 'exp_max': 56},
    ...
    'weight': 7, 'area': 3, 'element': 'mana', 'exp_min': 22, 'exp_max': 56},
    ...
    'weight': 6, 'area': 3, 'element': 'nature', 'exp_min': 22, 'exp_max': 56},
    ...
    'weight': 6, 'area': 4, 'element': 'nature', 'exp_min': 33, 'exp_max': 84},
    ...
    'weight': 5, 'area': 4, 'element': 'ice', 'exp_min': 33, 'exp_max': 84},
    ...
    'weight': 5, 'area': 4, 'element': 'fire', 'exp_min': 33, 'exp_max': 84},
    ...
    'weight': 3, 'area': 5, 'element': 'mana', 'exp_min': 50, 'exp_max': 126},
    ...
    'weight': 2, 'area': 7, 'element': 'mana', 'exp_min': 113, 'exp_max': 284},
    ...
    'weight': 1, 'area': 8, 'element': 'mana', 'exp_min': 170, 'exp_max': 427},
    ...
    'weight': 1, 'area': 9, 'element': 'mana', 'exp_min': 256, 'exp_max': 640},
    ...
    'weight': 1, 'area': 10, 'element': 'mana', 'exp_min': 384, 'exp_max': 961},
    ...
    'weight': 1, 'area': 1, 'exp_min': 250, 'exp_max': 500},
    ...
    'weight': 1, 'area': 3, 'exp_min': 562, 'exp_max': 1125},
    ...
    'weight': 1, 'area': 4, 'exp_min': 843, 'exp_max': 1687},
    ...
    'weight': 1, 'area': 5, 'exp_min': 1265, 'exp_max': 2531},
    ...
    'weight': 1, 'area': 6, 'exp_min': 1898, 'exp_max': 3796},
    ...
    'weight': 1, 'area': 7, 'exp_min': 2847, 'exp_max': 5695},
    ...
    'weight': 1, 'area': 8, 'exp_min': 4271, 'exp_max': 8542},
    ...
    'weight': 1, 'area': 9, 'exp_min': 6407, 'exp_max': 12814},
    ...
    'weight': 1, 'area': 10, 'exp_min': 9610, 'exp_max': 19221},
    ...
    'weight': 0.01, 'area': 10, 'exp_min': 8000000000, 'exp_max': 10000000000}
    ]
MONSTER_ALIASES = {
